...
import com.example.lenovo.inequalitysign.ui.CommentAddActivity;
...
public class OrderedAdapter extends BaseAdapter {
    ...
    public OrderedAdapter(Context context, List<Order> ls) {
        this.ls = ls;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            view = LayoutInflater.from(context).inflate(R.layout.ordered_item,null);
        }
        ...
        Button comment = (Button) view.findViewById(R.id.BtnComment);
